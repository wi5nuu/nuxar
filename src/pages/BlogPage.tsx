            ...
            <section className="pt-8 pb-16 px-6 lg:px-16">
                <div className="max-w-5xl mx-auto">
                        ...
                        {loading ? (
                            ...
                            posts.map((post, i) => (
                                <div
                                    ...
                                    className="group rounded-3xl overflow-hidden bg-white/5 border border-white/10 hover:border-highlight/30 transition-all duration-300"
                                >
                                    ...
                                    <div className="p-6">
                                        <div className="flex items-center gap-4 mb-4">
                                            ...
                                            <span className="flex items-center gap-1 text-[10px] text-white/40 uppercase tracking-tighter">
                                        ...
                                        <h2 className="text-xl font-bold mb-3 group-hover:text-highlight transition-colors">
                                            {post.title}
                                        </h2>
                                        <p className="text-white/60 text-sm leading-relaxed mb-5">{post.excerpt}</p>
                                        <Link
                                            to={`/blog/${post.slug}`}
                                            className="inline-flex items-center gap-2 text-sm font-semibold text-white/70 hover:text-white group/btn transition-colors"
                                        >
                                            Baca Selengkapnya
                    ...
                    <div className="mt-16 p-8 rounded-3xl bg-gradient-to-r from-highlight/10 to-transparent border border-highlight/20 text-center">
                        <h2 className="text-2xl font-bold mb-2">Punya Pertanyaan Soal Parfum?</h2>
                        <p className="text-white/60 mb-6">Tim ahli NUXAR siap membantu Anda menemukan aroma signature yang tepat.</p>
                        <a
