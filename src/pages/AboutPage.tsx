...
export function AboutPage() {
    ...
    useEffect(() => {
        ...
        gsap.from(statsRef.current, { y: 30, opacity: 0, duration: 0.8, delay: 0.3, ease: 'power2.out' });
    }, []);
    ...
    return (
        <PageLayout breadcrumbs={[{ label: 'Tentang Kami' }]}>
            <SEOHead
                title="Tentang Kami – NUXAR PERFUMERY | Parfum Eceran Premium Indonesia"
                description="NUXAR PERFUMERY adalah brand parfum eceran premium Indonesia. Kami menyediakan parfum original dari distributor resmi dengan kemasan eceran terjangkau untuk mahasiswa, pekerja, dan traveler."
                keywords="tentang nuxar perfumery, parfum eceran premium indonesia, brand parfum lokal, nuxar perfumery profile, parfum original indonesia"
            ...
            {/* Stats */}
            <section className="py-16 px-6 lg:px-16 bg-white/3 border-y border-white/10">
                <div className="max-w-6xl mx-auto">
            ...
            {/* Mission */}
            <section className="py-16 px-6 lg:px-16 bg-white/3 border-t border-white/10">
