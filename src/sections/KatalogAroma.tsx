            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-10">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                ...
                <TabsList className="h-12 w-full sm:w-fit grid grid-cols-2 rounded-xl border border-black/10 bg-white p-1 shadow-sm">
                  <TabsTrigger value="cowok" className="rounded-lg px-6 py-1.5 text-[10px] font-black uppercase tracking-widest transition-all data-[state=active]:bg-highlight data-[state=active]:text-black text-black font-bold data-[state=active]:opacity-100">
                    Men ({perfumes.cowok.length})
                  </TabsTrigger>
                  <TabsTrigger value="cewek" className="rounded-lg px-6 py-1.5 text-[10px] font-black uppercase tracking-widest transition-all data-[state=active]:bg-highlight data-[state=active]:text-black text-black font-bold data-[state=active]:opacity-100">
